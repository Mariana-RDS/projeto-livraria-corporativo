    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/livros/{id}").hasAnyRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/vendas/delete/{id}").hasAnyRole("ADMIN")
                        .requestMatchers("/api/livros/**").hasAnyRole("USER", "ADMIN")
                        .requestMatchers("/api/estoque/**").hasAnyRole("ADMIN")
                        .requestMatchers("/api/estoque/livros/{id}").hasAnyRole( "ADMIN")
